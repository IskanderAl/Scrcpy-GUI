...
2. Скачай `scrcpy-gui-setup-v2.0.0.exe`
...
1. Скачай `scrcpy-gui-v2.0.0-win64.zip` из [Releases](../../releases/latest)
...
3. Нажми **Mirror Screen** — откроется окно зеркалирования
4. Настрой параметры: формат, разрешение, битрейт, FPS, ориентация, аудио
5. Нажми **Record** — зеркало закроется, начнётся запись с таймером
6. Нажми **Stop** — файл сохранится как `record_YYYY-MM-DD_HH-MM-SS.mkv`
